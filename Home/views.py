    ...
    if not request.user.is_authenticated():
        ...
        if form.is_valid():
            ...
            if file_type not in IMAGE_FILE_TYPES:
                ...
                return render(request, 'Home/album_form.html', context)
            album.save()
    ...
    if form.is_valid():
        ...
        for s in albums_songs:
            if s.song_title == form.cleaned_data.get("song_title"):
                ...
                return render(request, 'Home/song_form.html', context)
...
def detail(request, album_id):
    if not request.user.is_authenticated():
        ...
        user = request.user
        album = get_object_or_404(Album, pk=album_id)
        return render(request, 'Home/detail.html', {'album': album, 'user': user})
...
def songs(request, filter_by):
    if not request.user.is_authenticated():
        ...
        try:
            ...
            users_songs = []
        return render(request, 'Home/songs.html', {
